...
namespace marshaw.skill
{
    ...
    public class cwt_class
    {
        ...
        public static readonly ConditionalWeakTable<Player, cwt_doubleJ> cwt_var = new();
        public static cwt_doubleJ GetCwt(Player self) => cwt_var.GetValue(self, _ => new());
